...
DESKTOP_PAYLOAD_DIR=${DESKTOP_PAYLOAD_DIR:-"$ARTIFACT_DIR/desktop-payload"}
DESKTOP_PAYLOAD_TARBALL=${DESKTOP_PAYLOAD_TARBALL:-"$ARTIFACT_DIR/desktop-payload.tar.gz"}
DESKTOP_ASSETS_DIR=${DESKTOP_ASSETS_DIR:-"$HARNESS_DIR/vm/desktop"}
